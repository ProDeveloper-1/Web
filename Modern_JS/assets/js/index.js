...
// Class
// Does the same as the above function of which is the best practice
class Person_2 {
    constructor(first_Name2, last_Name2, do_b2, address) {
...
// Instantiate object
const person5 = new Person_2('Nicholas', 'Mbuma', '07-07-1964', 'Iringa, Tanzania.');
console.log('My Father is ' + person5.getFull_Name2() + ', he was born in ' + person5.getBirth_Year2() + ' in ' + person5.address);

const person6 = new Person_2('', '', '05-25-1971');
person6.first_Name2 = 'Jane';
person6.last_Name2 = 'Katunzi';
person6.address = 'Kagera, Tanzania.'
console.log('My Mother is ' + person6.getFull_Name2() + ', she was born in ' + person6.getBirth_Year2() + ' in ' + person6.address);
...
formSubmit.addEventListener('click', (e) => {
    ...
    if (userName.value === '') {
        ...
        // SetTimeOut to remove the msg div
        setTimeout(function () {
